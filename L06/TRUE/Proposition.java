...
public abstract class Proposition {
    ...
    /**
     * Returns a string representation of a proposition. The string representation
     * should include parentheses to indicate the operator precedence. Example: (p &
     * q) | r As a challenge problem, implement this method such that parens are
     * dropped if the operators are of the same type. Example: (p & q & r) | (q |
     * ~r)
     * 
    ...
    /**
     * @return true is the proposition is binary -- i.e., it is of the form phi1
     *         OPERATOR phi2 where OPERATOR is some logical connective.
     */
    ...
    /**
     * If the proposition is binary -- i.e., it is of the form phi1 OPERATOR phi2
     * where OPERATOR is some logical connective, the respective operator is
     * returned (see finals above).
     * 
     ...
     *
     * @return the logical connective associated with this sentence if it has one,
     *         otherwise null
     */
    ...
    /**
     * If the proposition is binary -- i.e., it is of the form phi1 OPERATOR phi2 --
     * then phi1 is returned.
     *
     * Example: if proposition is (p | r) & q, it returns (p | r).
     *
     * If the proposition is unary -- i.e., it is of the form OPERATOR phi1 where
     * OPERATOR is some logical connective -- then phi1 is returned.
     *
     * Example: if proposition is ~p, it returns p.
     *
     * @return the left argument if it is binary, the argument if it is unary,
     *         otherwise null
     */
    ...
    /**
     * If the proposition is binary -- i.e., it is of the form phi1 OPERATOR phi2
     * where OPERATOR is some logical connective -- then phi2 is returned.
     *
     * Example: if proposition is (p | r) & q, it returns q.
     *
     * @return the right argument if this sentence is a binary proposition,
     *         otherwise null
     */
     ...
     *
     * Example: if proposition is (p | r) & q, then hasConnective(&) is true, but
     * hasConnective(|) is false.
     *

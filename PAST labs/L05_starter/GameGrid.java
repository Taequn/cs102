...
//Represents a the grid that stores the state of our "game board"
//Grid is a matrix of cells; each cell can contain
public class GameGrid extends JComponent implements KeyListener {
    ...
    //sets the background color of the cell at the argument Location
    ...
    //gets the background color of the cell at the argument Location
    ...
    //sets the background of the grid to the argument image file name; null for no background image
    ...
    //sets the background of the grid to the argument color; null for no (i.e. default) color
    ...
    //sets spalsh image drawn drawn on top of the grid to the arg image file
